...
import { RateCardItem, ServiceOffering, SiteSettings } from '../types';
...
const About: React.FC<AboutProps> = ({ settings, services, rateCards, onBook }) => {
  return (
    <div className='max-w-6xl mx-auto py-16 animate-in fade-in slide-in-from-bottom-4 duration-700 space-y-12'>
      ...
      <div className='space-y-4'>
        ...
        <div className='pt-2'>
          <button
            onClick={onBook}
            className='btn-amber px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest'
          >
            Book Me
          </button>
        </div>
