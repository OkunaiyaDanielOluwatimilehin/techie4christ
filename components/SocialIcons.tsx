...
export const SocialIcon: React.FC<{ platform: string; className?: string }> = ({ platform, className = "w-5 h-5" }) => {
  switch (platform.toLowerCase()) {
    ...
    case 'substack':
      return (
        <svg className={className} fill="currentColor" viewBox="0 0 24 24">
          <path d="M4 3.75h16v2.25H4zm0 4.5h16v2.25H4zm0 4.5h16l-1.125 7.5L12 17.25l-6.875 3L4 12.75z" />
        </svg>
      );
    default:
      return <span className="text-[10px] font-bold">{platform.substring(0,2)}</span>;
  }
};
