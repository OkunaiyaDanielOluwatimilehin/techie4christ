        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Use this form for direct questions, partnerships, or speaking requests. For strategy work and consulting,
              head to the Services page and book a session.
            </p>
          </div>
        ...
        <div className="glass-card p-8 rounded-[2rem] border-white/10">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <textarea 
              ...
              name="message"
              rows={4}
              className="w-full bg-slate-950/50 border border-white/10 rounded-xl px-5 py-3 text-sm outline-none focus:border-amber-400 resize-none text-white"
              placeholder="Message"
