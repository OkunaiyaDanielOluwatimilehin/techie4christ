...
#mlb2-38091339.ml-form-embedContainer .ml-form-embedWrapper .ml-form-embedBody { padding: 8px 0 0 0; }
#mlb2-38091339.ml-form-embedContainer .ml-form-embedWrapper .ml-form-embedBody .ml-form-embedContent,
#mlb2-38091339.ml-form-embedContainer .ml-form-embedWrapper .ml-form-successBody .ml-form-successContent { margin: 0 0 16px 0; }
#mlb2-38091339.ml-form-embedContainer .ml-form-embedWrapper .ml-form-embedBody .ml-form-fieldRow { margin: 0 0 14px 0; }
...
#mlb2-38091339.ml-form-embedContainer .ml-form-embedWrapper .ml-form-successBody { padding: 20px 20px 0 20px; }
#mlb2-38091339.ml-form-embedContainer .ml-form-embedWrapper .ml-form-successBody { background: var(--surface-2); border: 1px solid var(--border); border-radius: 16px; padding: 22px 22px 18px 22px; }
...
#mlb2-38091339.ml-form-embedContainer .ml-form-embedWrapper .ml-form-embedBody .ml-form-embedContent,
#mlb2-38091339.ml-form-embedContainer .ml-form-embedWrapper .ml-form-successBody .ml-form-successContent { text-align: left; margin: 0 0 20px 0; }
...
#mlb2-38091339.ml-form-embedContainer .ml-form-embedWrapper .ml-block-form .ml-field-group label { margin-bottom: 6px; color: #94a3b8; font-size: 12px; font-family: 'Open Sans', Arial, Helvetica, sans-serif; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; font-style: normal; text-decoration: none; display: inline-block; line-height: 18px; }
...
#mlb2-38091339.ml-form-embedContainer .ml-form-embedWrapper .ml-form-embedBody .ml-form-checkboxRow { margin: 0 0 20px 0; width: 100%; }
...
#mlb2-38091339.ml-form-embedContainer .ml-form-embedWrapper .ml-form-embedBody .ml-form-fieldRow input { background-color: rgba(15,23,42,0.8) !important; color: #e2e8f0 !important; border-color: rgba(255,255,255,0.12); border-radius: 10px !important; border-style: solid !important; border-width: 1px !important; font-family: 'Open Sans', Arial, Helvetica, sans-serif; font-size: 14px !important; height: auto; line-height: 21px !important; margin-bottom: 0; margin-top: 0; margin-left: 0; margin-right: 0; padding: 12px 12px !important; width: 100% !important; box-sizing: border-box !important; max-width: 100% !important; }
